    ...
    public sealed class SQLiteConnection : DbConnection, ICloneable, IDisposable
    {
        ...
        public static SQLiteConnectionFlags DefaultFlags
        {
            get
            {
                ...
                {
                    settingValue = EntityWorker.SQLite.UnsafeNativeMethods.GetSettingValue(str, null);
        ...
        private DataTable Schema_DataTypes()
        {
            ...
            dataTable.BeginLoadData();
            StringReader stringReader = new StringReader(EntityWorker.SQLite.SR.DataTypes);
        ...
        private static DataTable Schema_MetaDataCollections()
        {
            ...
            dataTable.BeginLoadData();
            StringReader stringReader = new StringReader(EntityWorker.SQLite.SR.MetaDataCollections);
            dataTable.ReadXml(stringReader);
            stringReader.Close();
            dataTable.AcceptChanges();
            dataTable.EndLoadData();
        ...
        private static DataTable Schema_ReservedWords()
        {
            ...
            dataTable.BeginLoadData();
            string[] strArrays = EntityWorker.SQLite.SR.Keywords.Split(new char[] { ',' });
