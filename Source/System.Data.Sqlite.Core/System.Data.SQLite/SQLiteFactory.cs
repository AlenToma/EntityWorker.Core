...
namespace System.Data.SQLite
{
	public sealed class SQLiteFactory : DbProviderFactory, IDisposable, IServiceProvider
	{
		...
		static SQLiteFactory()
		{
			...
			SQLiteFactory.DefaultTypeName = "System.Data.SQLite.Linq.SQLiteProviderServices, System.Data.SQLite.Linq, Version={0}, Culture=neutral, PublicKeyToken=db937bc2d44ff139";
		...
		private object GetSQLiteProviderServicesInstance()
		{
			...
			{
				string settingValue = System.Data.SQLite.UnsafeNativeMethods.GetSettingValue("TypeName_SQLiteProviderServices", null);
