    ...
    public sealed class SQLiteConnection : DbConnection, ICloneable, IDisposable
    {
        ...
        public static SQLiteConnectionFlags DefaultFlags
        {
            get
            {
                ...
                {
                    settingValue = UnsafeNativeMethods.GetSettingValue(str, null);
        ...
        static SQLiteConnection()
        {
            ...
            //EmbeddedDllClass.ExtractEmbeddedDlls("SQLite.Interop", Properties.x64.SQLite_Interop, "x64");
            //EmbeddedDllClass.ExtractEmbeddedDlls("SQLite.Interop", Properties.x86.SQLite_Interop, "x86");
        }
